...
class VoiceInputConnection(
    ...
    companion object {
        ...
        private const val COMPONENT_NAME = "VoiceInputConnection"
    }
    ...
    private val deathRecipient = IBinder.DeathRecipient {
        ...
        LogCatcher.markComponentActive(COMPONENT_NAME, "IPC Client", "Service Process Died - Recovering")
    ...
    private val serviceConnection = object : ServiceConnection {
        override fun onServiceConnected(name: ComponentName?, service: IBinder?) {
            LogCatcher.i(TAG, "Connected to VoiceInputService (:voice)")
            LogCatcher.markComponentActive(COMPONENT_NAME, "IPC Client", "Connected to :voice")
        ...
        override fun onServiceDisconnected(name: ComponentName?) {
            ...
            LogCatcher.markComponentActive(COMPONENT_NAME, "IPC Client", "Disconnected")
            serviceMessenger = null
            isBound = false
    ...
    fun connectAndStart(gainMultiplier: Int) {
        ...
        if (!isBound) {
            LogCatcher.i(TAG, "Binding to VoiceInputService with initial gain: ${gainMultiplier}x")
    ...
    fun stopAndDisconnect() {
        ...
        if (isBound) {
            ...
            isBound = false
            serviceMessenger = null
            LogCatcher.markComponentInactive(COMPONENT_NAME, "Disconnected and Unbound")
        }
    ...
    private fun handleServiceMessage(msg: Message): Boolean {
        when (msg.what) {
            ...
            VoiceIpcProtocol.EVENT_STATE_CHANGED -> {
                ...
                val state = VoiceIpcProtocol.ServiceState.entries.getOrNull(stateOrdinal)
